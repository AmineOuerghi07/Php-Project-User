...
if(isset($_POST['email']))
{
  ...
  {
    $clientC = new ClientC();
    $client = $clientC->getClientByEmail($_POST['email']);
    if($client)
    {
      $expire = time() + 300;
      $clientC->addReset($client['idClient'],date('Y-m-d H:i:s',$expire));
      $clientC->sendEmail($_POST['email'],"Reset Your Password","We received your request<br /><a href='http://127.0.0.1/PhpProject/Front%20End/View/reset-password.php?idClient=".$client['idClient']."'>Click Here</a><br />In order to make a new one.<br />P.S: This Link Will Expire in 5 Minutes");
      header("location: login.php");
    }
    else
      $error = "Please verify your email or register if you're not registered yet! <a href='register.php'>Click Here</a>";
  }
}
...
<!-- BEGIN Main Container -->  
  ...
  <!--page-title-->
       ...
       <div class="content">
                    ...
                    <p>Enter your email to receive a verification mail to reset your password</p>
                    <ul class="form-list">
                        <li>
                  ...
                  <button type="submit" class="button" title="Login" name="send" id="send2"><span>Reset Password</span></button>
