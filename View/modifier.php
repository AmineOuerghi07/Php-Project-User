...
if((isset($_POST["lname"]))
    ...
    && (isset($_POST["email"])))
    {
      ...
      && (!empty($_POST["email"])))
      {
        $c = new Client($_POST["lname"],$_POST["fname"],$_POST["tel"],$_POST["ad"],md5($_POST["pass"]),$_POST["email"]);
        $clientC->updateClient($_POST['idClient'],$c);
    ...
    $client = $clientC->getClientById($_POST['idClient']);
                  ...
                  <div class="no-js"> <a title="" class="clicker"></a>
                    <div class="fl-nav-links">
                      <div class="language-currency">
                       ...
                       <h3>My Acount</h3>
                      <ul class="links">
                        <li><a href="logout.php" title="My Account">Logout</a></li>
                        </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class="content">
                    ...
                    <ul class="form-list">
                        <li>
                            ...
                            <div class="input-box">
                                <input type="text" name="fname" value="<?php echo $client['prenom']; ?>" class="input-text required-entry validate-email" title="First Name" required>
                            </div>
                        </li>
                        <li>
                            <label for="last-name">Last Name<em class="required">*</em></label>
                            <div class="input-box">
                                <input type="text" name="lname" value="<?php echo $client['nom']; ?>" class="input-text required-entry validate-password" title="Last Name" required>
                            </div>
                        </li>
                        <li>
                            <label for="email">Email Address<em class="required">*</em></label>
                           <div class="input-box">
                               <input type="email" name="email" value="<?php echo $client['email']; ?>" id="email" class="input-text required-entry validate-email" title="Email Address" required>
                           </div>
                       </li>
                        <li>
                            <label for="Address">Address<em class="required">*</em></label>
                            <div class="input-box">
                                <textarea name="ad"><?php echo $client['address']; ?></textarea>
                            </div>
                        </li>
                        <li>
                            <label for="phone-number">Phone Number<em class="required">*</em></label>
                            <div class="input-box">
                                <input type="text" name="tel" value="<?php echo $client['tel']; ?>" class="input-text required-entry validate-password" title="Phone" required>
                            </div>
                        </li>
                        <li>
                            <label for="pass">Password<em class="required">*</em></label>
                            <div class="input-box">
                                <input type="password" name="pass" value="" class="input-text required-entry validate-password" pattern="(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])\S{8,}" title="Password" required>
                            </div>
                        </li>
                        <li>
                            <label for="cpass">Confirm Password<em class="required">*</em></label>
                            <div class="input-box">
                                <input type="password" value="" name="cpass" class="input-text required-entry validate-password" pattern="(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])\S{8,}" title="CPassword" required>
                            </div>
                        </li>
                    </ul>
...
<p class="required">* Required Fields</p>
                    ...
                    <button type="submit" class="button login" title="Login" name="send" id="send2"><span>Modifier</span></button>
