...
$clientC = new ClientC();
$client = $clientC->getClientById($_SESSION['idClient']);    

if(isset($_POST['resend']))
{
  $clientC->sendEmail($client['email'],"Account Confirmation","In order to confirm your account click the link below<br /><a href='http://127.0.0.1/PhpProject/Front%20End/View/confirm-account.php?idClient=".$client['idClient']."'>Confirm Account</a><br /><br />Have a nice day !");
...
<h3>Nom:</h3> <br> <?php echo $client['nom'];?>
<h3>Prenom:</h3> <br> <?php echo $client['prenom'];?> 
<h3>Phone:</h3> <br> <?php echo $client['tel'];?> 
<h3>Address:</h3> <br> <?php echo $client['address'];?> 
<h3>Email:</h3> <br> <?php echo $client['email'];?> 
<br>
...
<br>
   ...
   <form method="POST" action="modifier.php">
       <input type="hidden" name="idClient" value="<?php echo $client['idClient']; ?>" >
        ...
        <br />
       <br />
        <a href="deleteClient.php?idClient=<?php echo $client['idClient'];?>">Supprimer</a> 
   </form>
...
<br />
<?php
if($client['confirme'] == 0)
{
echo "<strong><font color='red'>Your account is not activated please check your email or click the button below to resend the confirmation mail</font></strong><br />
<form method='POST'>
 <input type='hidden' name='idClient' value='".$client['idClient']."'> <br />
 <input type='submit' name='resend' value='Resend Confirmation'>
 </form>";
}
